...
using System.Data.SqlClient;    // For saving to SQL Server
...
namespace FinalADB
{
    public partial class ContactsForm : Form
    {
        ...
        {
            string command = "adb shell content query --uri content://contacts/phones/";
            string outputFile = "contacts.txt";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=C:\\Users\\Spark\\OneDrive\\Documents\\FinalADB.mdf;Integrated Security=True;Connect Timeout=30"))
            {
                ...
                {
                    SqlCommand cmd = new SqlCommand("INSERT INTO ContactsTable (RawData) VALUES (@data)", con);
